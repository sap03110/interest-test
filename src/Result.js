...
const Result = (props) => {
    ...
    const chartInfo = {
        options: {
            ...
            xaxis: {
              categories: props.answer2.map(item => {return item.id})
            },
            colors: [
                '#d94925'
            ],
          ...
          series: [
            {
              name: "역량지수",
              data: props.answer2.map(item => {return item.value})
            }
        ],
    };
                ...
                <div className="result-cont">
                    ...
                    <div className="share-div">
                        ...
                        <ul className="share-btn-list">
                            ...
                            <li className="share-btn twitter" onClick={
                                () => window.open("https://www.twitter.com/intent/tweet?text="+encodeURIComponent("내 성격과 딱 맞는 4차 산업혁명 분야는?")+"&url="+encodeURIComponent("https://guiyomj.github.io/interest-test/"))
                            }>
                            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512">
                            ...
                            <li className="share-btn link">
                                <CopyToClipboard text="https://guiyomj.github.io/interest-test/" onCopy={
                                    () => alert("URL이 복사되었습니다.")
                                }>
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="18" height="24" viewBox="0 0 512 512">
                                        <path fill="#444" d="M406,332c-29.641,0-55.761,14.581-72.167,36.755L191.99,296.124c2.355-8.027,4.01-16.346,4.01-25.124
